...
v>> Do a few C-n's to bring the cursor down to this line.
...
>> Move the cursor the previous paragraph and type M-q.
...
vCompletion is a way to avoid unnecessary typing.  For instance, if you
